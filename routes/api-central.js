...
var addClass = function (req, res) {
    ...
    var onSemesterFind = function(err, result) {
        if(err) {
            ...
            req.db.collection('classes').insert({class_number: classNumber, students: students, title: title, code: code, slot: slot, venue: venue, units: units, class_dates: classDates, type: type, total: 0}, onInsert);
        }
    }
